...
import expo.modules.mbxnavigation.R
import expo.modules.mbxnavigation.databinding.NavigationViewBinding
...
class MBXNavigationView(context: Context) : FrameLayout(context) {

    private companion object {
        private const val BUTTON_ANIMATION_DURATION = 1500L
    }

    private val onRouteStarted by callback<String>()
    ...
    fun onCreate() {
        ...
        binding.mapView.location.apply {
            this.locationPuck = LocationPuck2D(
                bearingImage = resources.getDrawable(R.drawable.mapbox_navigation_puck_icon)
            )
